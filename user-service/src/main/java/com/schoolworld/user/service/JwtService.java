...
public class JwtService {
    ...
    public String generateToken(String email) {
        User user = this.userRepository.findUserByEmail(email).orElseThrow(() -> new BadCredentialsException(Constants.USER_NOT_FOUND));
        if (!user.isActive()) {
            Role role = this.roleRepository.findRoleByUserId(user.getId());
